...
const BUNDLED: &[(&str, &[&str])] = &[
    ...
    (
        "dolphin-swim",
        &[
            include_str!("../assets/anim/dolphin-swim/00.txt"),
            include_str!("../assets/anim/dolphin-swim/01.txt"),
            include_str!("../assets/anim/dolphin-swim/02.txt"),
            include_str!("../assets/anim/dolphin-swim/03.txt"),
            include_str!("../assets/anim/dolphin-swim/04.txt"),
            include_str!("../assets/anim/dolphin-swim/05.txt"),
            include_str!("../assets/anim/dolphin-swim/06.txt"),
            include_str!("../assets/anim/dolphin-swim/07.txt"),
            include_str!("../assets/anim/dolphin-swim/08.txt"),
        ],
    ),
    (
        "blackhole",
    ...
    (
        "saturn",
        &[
            include_str!("../assets/anim/saturn/00.txt"),
            include_str!("../assets/anim/saturn/01.txt"),
            include_str!("../assets/anim/saturn/02.txt"),
            include_str!("../assets/anim/saturn/03.txt"),
            include_str!("../assets/anim/saturn/04.txt"),
            include_str!("../assets/anim/saturn/05.txt"),
            include_str!("../assets/anim/saturn/06.txt"),
            include_str!("../assets/anim/saturn/07.txt"),
        ],
    ),
];
